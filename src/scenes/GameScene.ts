...
export default class GameScene extends Phaser.Scene {
  ...
  public create() {
    ...
    this.cameras.main.setBounds(0, 0, this.level_width*tileSize, this.level_height*tileSize);
    this.cameras.main.deadzone = new Phaser.Geom.Rectangle(100, 100, 220, 140);
    this.physics.world.setBounds(0, 0, this.level_width*tileSize, this.level_height*tileSize);
